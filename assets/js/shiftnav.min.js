...
if("click"!=c.originalEvent.type||!b(this).data("disableToggle"))return d.$shiftnav.hasClass("shiftnav-open-target")?d.closeShiftNav():(a="shiftnav-toggle-main"==b(this).attr("id")?"[Main Toggle Bar]":'"'+b(this).text()+'"',d.openShiftNav("toggle: "+a)),"click"!=c.originalEvent.type&&(b(this).data("disableToggle",!0),setTimeout(function(){b(this).data("disableToggle",!1)},1E3)),!1},initializeSwipeHandler:function(){b("body");var a=0,d=0,c=0,e=0,g=0,l=0,h=this,k=!1,n=b(f).height(),m=this.$shiftnav.find(".shiftnav-inner");
m.on("touchstart",function(b){a=b.originalEvent.changedTouches[0].pageY;d=b.originalEvent.changedTouches[0].pageX});m.on(this.touchMove,function(b){k=!1;n>=m[0].scrollHeight?(k=!0,b.preventDefault()):0===b.currentTarget.scrollTop?(c=b.originalEvent.changedTouches[0].pageY,c>a&&(k=!0,b.preventDefault())):b.currentTarget.scrollHeight===b.currentTarget.scrollTop+b.currentTarget.offsetHeight&&(c=b.originalEvent.changedTouches[0].pageY,c<a&&(k=!0,b.preventDefault()));k||(g=Math.abs(a-b.originalEvent.changedTouches[0].pageY),
l=Math.abs(d-b.originalEvent.changedTouches[0].pageX),g<l&&b.preventDefault())});if("on"==shiftnav_data.swipe_close)if(this.$shiftnav.hasClass("shiftnav-right-edge"))m.on("touchmove",function(b){e=b.originalEvent.changedTouches[0].pageX;e-d>h.settings.swipe_tolerance_x&&Math.abs(c-a)<h.settings.swipe_tolerance_y&&(h.closeShiftNav(),b.preventDefault())});else m.on("touchmove",function(b){e=b.originalEvent.changedTouches[0].pageX;d-e>h.settings.swipe_tolerance_x&&(c=b.originalEvent.changedTouches[0].pageY,
...
a.closest("ul").addClass("shiftnav-sub-active-current");a.trigger("shiftnav-close-submenu")},closeAllSubmenus:function(){b(this.element).find("li.menu-item-has-children").removeClass("shiftnav-active")}};b.fn.shiftnav=function(a){var d=arguments;if(a===l||"object"===typeof a)return this.each(function(){b.data(this,"plugin_shiftnav")||b.data(this,"plugin_shiftnav",new q(this,a))});if("string"===typeof a&&"_"!==a[0]&&"init"!==a){var c;this.each(function(){var e=b.data(this,"plugin_shiftnav");e instanceof
q&&"function"===typeof e[a]&&(c=e[a].apply(e,Array.prototype.slice.call(d,1)));"destroy"===a&&b.data(this,"plugin_shiftnav",null)});return c!==l?c:this}}})(jQuery,window,document);
...
f.addClass("current-menu-item")));b(".shiftnav").trigger("shiftnav-loaded")});var shift_supports=function(){var b=document.createElement("div"),f=["Khtml","Ms","O","Moz","Webkit"];return function(g){var l=f.length;if(g in b.style)return!0;for(g=g.replace(/^[a-z]/,function(b){return b.toUpperCase()});l--;)if(f[l]+g in b.style)return!0;return!1}}();
